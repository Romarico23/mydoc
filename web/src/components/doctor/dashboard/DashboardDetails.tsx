	...
	return (
		<div className="grid grid-cols-1 gap-5">
			<div className="flex flex-col md:flex-row justify-center gap-5">
				<Card>
					<CardHeader>
						<CardTitle>Bar Chart - Total Earnings</CardTitle>
					...
					<CardFooter className="flex flex-col items-center text-sm">
						<div className="leading-none text-muted-foreground">
							Total Earnings over the past 6 months
						</div>
					</CardFooter>
				</Card>
			...
			<div className="grid md:grid-cols-3 gap-3">
				<DashboardCard
					icon={<Banknote size={40} className="text-cyan-500" />}
					count={`${viewDashboard?.dashboardData.totalEarnings} $`}
					description="Total Earnings (Yearly)"
				/>
				<DashboardCard
